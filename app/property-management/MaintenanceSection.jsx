...
const MaintenanceSection = ({
  ...
  return (
    <div className="p-4 flex flex-col h-full bg-white/80 rounded-lg">
      ...
      {/* MAIN FORM CONTENT - Mobile First Approach */}
      <div className="flex flex-col space-y-6">
        {/* Company Section - Button positioned next to label */}
        ...
        {/* Category Section - Button positioned next to label */}
        <div className="w-full">
          <div className="flex flex-col space-y-2">
            <div className="flex flex-row items-center space-x-2">
              <label className="font-medium text-dark">Category</label>
              <Button
                variant="contained"
                startIcon={<AddCircleOutlineIcon />}
                className="bg-primary hover:bg-secondary hover:text-primary text-dark font-medium px-2 py-1 rounded-lg shadow-md transition-colors duration-300"
            ...
            {errors.selectedCategory && (
              <p className="text-primary text-sm">{errors.selectedCategory}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="w-full">
              <Button
                ...
                className="bg-primary hover:bg-secondary hover:text-primary text-dark font-medium rounded-lg w-full"
                sx={{
                  textTransform: "none",
                  fontSize: "0.9rem",
                  padding: "8px 16px",
          ...
          {/* Right Column - Description with reduced height */}
          <div className="flex flex-col h-full">
            ...
            <TextField
              ...
              multiline
              rows={6} // Reduced from 10 to 6 for better proportions
              fullWidth
        ...
        <div className="flex justify-center mt-6">
          <Button
            variant="contained"
            className="bg-primary hover:bg-secondary hover:text-primary text-dark font-medium px-8 py-2 rounded-lg w-full sm:w-auto max-w-xs"
            sx={{
              textTransform: "none",
              fontSize: "1rem",
            }}
      ...
      {/* All your dialogs remain unchanged */}
      <AddCompanyDialog
